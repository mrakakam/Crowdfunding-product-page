      ...
      <section className="max-w-2xl mx-4 md:mx-auto bg-white rounded-xl shadow-lg p-8 mt-8 space-y-8">
        ...
        <div className="border border-gray-300 rounded-xl p-6 text-left space-y-4">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
            <h2 className="font-bold text-lg">Bamboo Stand</h2>
            <p className="text-[#008b8b] font-medium">Pledge $25 or more</p>
          </div>
        ...
        <div className="border border-gray-300 rounded-xl p-6 text-left space-y-4">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
            <h2 className="font-bold text-lg">Black Edition Stand</h2>
            <p className="text-[#008b8b] font-medium">Pledge $75 or more</p>
          </div>
          <p className="text-gray-600 text-sm leading-relaxed">
        ...
        <div className="border border-gray-300 rounded-xl p-6 text-left space-y-4 opacity-50">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
            <h2 className="font-bold text-lg">Mahogany Special Edition</h2>
            <p className="text-[#008b8b] font-medium">Pledge $200 or more</p>
          </div>
          <p className="text-gray-600 text-sm leading-relaxed">
